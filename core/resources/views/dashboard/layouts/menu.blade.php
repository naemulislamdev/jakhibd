    ...
    <div class="left navside dark dk" layout="column">
        <div class="navbar navbar-md no-radius">
            ...
            <a class="navbar-brand" href="{{ route('adminHome') }}">
                ...
                <span class="hidden-folded inline">{{ __('JAKHIBD') }}</span>
            </a>
            <!-- / brand -->
        </div>
        <div flex class="hide-scroll">
            <nav class="scroll nav-active-primary">
                ...
                <ul class="nav" ui-nav>
                    ...
                    @endif
                    <li>
                        <a href="{{ route('lifeMember.index') }}">
                            <span class="nav-icon">
                                <i class="material-icons">&#xe433;</i>
                            </span>
                            <span class="nav-text">{{ __('Life Member') }}</span>
                        </a>
                    </li>
                    <li>
                        <a>
                    ...
                    <li>
                        <a href="{{ route('committeeType.index') }}">
                            <span class="nav-icon">
                                <i class="material-icons">&#xe433;</i>
                            </span>
                            <span class="nav-text">{{ __('Committee Type') }}</span>
                        </a>
                    </li>
                    <li>
                        <a>
                            ...
                            <span class="nav-text">{{ __('Committee') }}</span>
                        </a>
                        <ul class="nav-sub">
                            @php
                                $committeeTypes = App\Models\CommitteeType::where('is_active',true)->get();
                            @endphp

                            <li>
                                <a href="{{ route('committee.create')}}">
                                    <span class="nav-text">{{ __('Committee create') }}</span>
                                </a>
                            </li>
                            @foreach($committeeTypes as $committeeType)
                            <li>
                                <a href="{{ route('committee.index',$committeeType->id)}}">
                                    <span class="nav-text">{{ $committeeType->name}}</span>
                                </a>
                            </li>
                            @endforeach
                        </ul>
                    ...
                    <li>
                        <a>
                            ...
                            <span class="nav-text">{{ __('Student Management') }}</span>
                        </a>
                        <ul class="nav-sub">
                            <li>
                        ...
                        <ul class="nav-sub">
                            <li>
                                <a href="{{ route('student.result.index')}}">
                                    <span class="nav-text">{{ __('Result list') }}</span>
                                </a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a>
                            ...
                            <span class="nav-text">{{ __('Teacher Management') }}</span>
                        </a>
                        <ul class="nav-sub">
                            <li>
                                <a href="{{ route('dashboard.teacher.index')}}">
                                    <span class="nav-text">{{ __('Teacher list') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('teacher.create')}}">
                                    <span class="nav-text">{{ __('Teacher create') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
