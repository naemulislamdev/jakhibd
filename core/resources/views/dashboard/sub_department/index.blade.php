...
@section('content')
                ...
                <table class="table table-bordered" style="width: 100%" id="dataTable">
                    ...
                    <tbody>
                        @foreach ($subDepartments as $subDepartment)
                            ...
                            <!-- delete Modal -->
                            <div class="modal fade" id="deleteRecord__{{ $subDepartment->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('sub.department.destroy', $subDepartment->id) }}"
                            ...
                            {{-- Edit Modal --}}
                            <div class="modal fade" id="editRecord__{{ $subDepartment->id }}" data-backdrop="static" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="department_id" class="form-control">
                                                        ...
                                                        <option {{$subDepartment->department_id == $department->id ? 'selected':'' }} value="{{$department->id}}">{{$department->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('department_id')
                                                        <span class="text-danger">{{ $message }}</span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" class="form-control">
                                                        <option {{$subDepartment->is_active == 1 ? 'selected':''}} value="1">Active</option>
                                                        <option {{$subDepartment->is_active == 0 ? 'selected':''}} value="0">Inactive</option>
                                                    </select>
                                                        @error('status')
                                                        <span class="text-danger">{{ $message}}</span>
                                                        @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="serial" placeholder="Enter serial number" class="form-control" value="{{$subDepartment->serial}}">
                                                    @error('serial')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
    ...
    <div class="modal fade" id="addRecords" tabindex="-1" data-backdrop="static" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create Sub Department</h5>
