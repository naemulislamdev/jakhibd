                    ...
                    <tbody>
                        @foreach ($students as $student)
                            <tr role="row">
                                ...
                                <td>
                                    <img src="@if($student->image) {{asset($student->image)}} @else {{ asset('assets/default/no-img.jpg')}} @endif" style="width: 50px; height:60px;">
                                </td>
                                <td>{{ $student->name }}</td>
                            ...
                            <!-- delete Modal -->
                            <div class="modal fade" id="deleteMember__{{ $student->id }}" tabindex="-1"
                            ...
                            {{-- Edit Modal --}}
                            <div class="modal fade" id="editRecord__{{ $student->id }}" data-backdrop="static" tabindex="-1" role="dialog"
