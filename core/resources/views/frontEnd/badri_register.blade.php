            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        @else
                            <li class="active">{{ __('বদরী ৩১৩ রেজিষ্ট্রার') }}</li>
                        @endif
                        @if (!empty($CurrentCategory))
                            ...
                            ?>
                            <li class="active"><i class="icon-angle-right"></i>{{ __('বদরী ৩১৩ রেজিষ্ট্রার') }}</li>
                        @endif
                    </ul>
                </div>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td style="text-align: center;">{{$badriRegister->phone}}</td>
                            <td style="text-align: center;">{{$badriRegister->rosit_no}}</td>
                          </tr>
                          @endforeach
                        </tbody>
                      </table>
