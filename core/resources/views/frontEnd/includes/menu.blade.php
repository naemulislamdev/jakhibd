    ...
    @if (count($HeaderMenuLinks) > 0)
        ...
        <div class="navbar-collapse collapse ">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="javascript:void(0)" class="dropdown-toggle " data-toggle="dropdown"
                        data-hover="dropdown" data-delay="0" data-close-others="true">বিভাগসমূহ<i
                            class="fa fa-angle-down"></i></a>
                            @php
                                $departments = App\Repositories\DepartmentRepository::query()->where('is_active',true)->get();
                            @endphp
                    <ul class="dropdown-menu">
                        @foreach($departments as $department)
                        <li><a href="{{ route('departmentStudent.index',$department->id)}}">{{$department->name}}</a>
                        </li>
                        @endforeach
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="javascript:void(0)" class="dropdown-toggle " data-toggle="dropdown"
                        data-hover="dropdown" data-delay="0" data-close-others="true">পরিচালনা পরিষদ<i
                            class="fa fa-angle-down"></i></a>
                            @php
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ route('committeeList',$committeeType->id)}}">{{$committeeType->name}}</a>
                        </li>
                        @endforeach
                    </ul>
                </li>
